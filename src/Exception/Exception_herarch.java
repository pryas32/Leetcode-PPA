...
//
//
//    throws-> this we use when we dont know how to handle th exception ,so whenever any function calls it it has to handle it or pass it to his caller
//
     //the function may through one or more exception its responsibility of the calling function to handle the exception
...
//
    ...
    //throws & thorw should have same excception match .
